  ...
  return (
    <div className="container" id="home">
      <div className="about-section">
        <div className="hero-badge">AI & DATA SCIENCE | ML | TRAINING</div>
        <img className="hero-avatar" src={profilePhoto} alt="Sudha Rani Maddala" />
        <div className="content">
          ...
          <p>Machine Learning Engineer | AI & Data Science | Training Facilitator</p>
          <div className="hero-intro">
            I build practical AI systems across machine learning, NLP, computer vision, speech AI and generative AI — and I turn those concepts into hands-on learning experiences.
          </div>
          <div className="hero-actions">
            <a href="#projects" className="hero-button primary">View projects</a>
            <a href="#training" className="hero-button secondary">AI training</a>
          </div>
      ...
      <div className="hero-strip">
        ...
        <div><strong>AI/ML</strong><span>NLP • CV • RAG<br />Speech & Real-time AI</span></div>
        <div><strong>UK</strong><span>Bristol-based<br />Open to UK roles</span></div>
      </div>
    </div>
  );
}
